export const apiEndpoints = {
  ...
  tenantReports: "/api/reports/",
  tenantSettings: "/api/settings/",
  tenantSettingsOrganization: "/api/settings/organization/",
  tenantSettingsEmailChange: "/api/settings/account/email-change/",
  tenantSettingsPasswordChange: "/api/settings/account/password-change/",
  tenantSettingsPasswordReset: "/api/settings/account/password-reset/",
  tenantSubscription: "/api/subscription/",
  tenantSubscriptionPlans: "/api/subscription/plans/",
  tenantSubscriptionBillingCycle: "/api/subscription/billing-cycle/",
  tenantSubscriptionPaymentMethod: "/api/subscription/payment-method/",
  tenantSubscriptionPaymentMethodSetup: "/api/subscription/payment-method/setup/",
  tenantSubscriptionPlanChange: "/api/subscription/plan-change/",
  tenantSubscriptionInvoices: "/api/subscription/invoices/",
  tenantReportDetail: (reportId: number) => `/api/reports/${reportId}/`,
